...
return [
    ...
    */
    ...
    'lte' => [
        ...
        'file' => 'Le champ :attribute doit peser au maximum :value kilooctets.',
    ...
    | les lignes. Cela facilite la définition d'une ligne de langue
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langue suivantes servent à remplacer le marqueur
    | d'attribut par un libellé plus lisible, comme « adresse e-mail » au lieu
    | de « email ». Cela nous aide simplement à rendre nos messages plus
    | expressifs.
    |
    */
    ...
    'attributes' => [
        ...
        'loan_product_id' => 'produit de prêt',
        'amount' => 'montant',
        'annual_rate' => 'taux annuel',
        'term_count' => 'nombre d\'échéances',
        'disbursed_at' => 'date de décaissement',
        'first_due_date' => 'première date d\'échéance',
        'purpose' => 'objet',
        'code' => 'code',
        'currency' => 'devise',
        'scale' => 'nombre de décimales',
        'min_principal' => 'principal minimum',
        'max_principal' => 'principal maximum',
        'processing_fee_percent' => 'frais de dossier (%)',
        'processing_fee_flat' => 'frais de dossier forfaitaires',
        'penalty_daily_rate' => 'taux de pénalité journalier',
        'penalty_grace_days' => 'jours de grâce',
        'penalty_base' => 'base de pénalité',
        'penalty_cap_percent' => 'plafond de pénalité (%)',
        'paymentAmount' => 'montant',
        'paymentDate' => 'date de paiement',
        'paymentMethod' => 'mode de paiement',
        'paymentReference' => 'référence',
        'payoffMethod' => 'mode de paiement',
        'payoffDate' => 'date de remboursement anticipé',
        'collateralType' => 'type de garantie',
        'collateralDescription' => 'description',
        'collateralValue' => 'valeur estimée',
        'guarantorName' => 'nom du garant',
        'guarantorPhone' => 'téléphone',
        'guarantorIdNumber' => 'numéro de pièce d\'identité',
        'guarantorRelationship' => 'lien de parenté',
        'rejectReason' => 'motif',
    ],
