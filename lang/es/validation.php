...
return [
    ...
    | predeterminados que utiliza la clase de validación. Algunas de estas
    | reglas tienen varias versiones, como las reglas de tamaño. Puede
    ...
    */
    ...
    | Esto facilita especificar una línea de idioma personalizada específica
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma se utilizan para reemplazar el marcador
    | de posición del atributo por algo más legible como "Dirección de correo
    ...
    */
    ...
    'attributes' => [
        ...
        'notes' => 'notas',
        'photo' => 'foto',
        'borrower_id' => 'prestatario',
        'loan_product_id' => 'producto de préstamo',
        'amount' => 'monto',
        'annual_rate' => 'tasa anual',
        'term_count' => 'número de cuotas',
        'disbursed_at' => 'fecha de desembolso',
        'first_due_date' => 'fecha del primer vencimiento',
        'purpose' => 'propósito',
        'code' => 'código',
        'currency' => 'moneda',
        'scale' => 'decimales',
        'min_principal' => 'capital mínimo',
        'max_principal' => 'capital máximo',
        'processing_fee_percent' => '% de comisión de gestión',
        'processing_fee_flat' => 'comisión de gestión fija',
        'penalty_daily_rate' => 'tasa de penalización diaria',
        'penalty_grace_days' => 'días de gracia',
        'penalty_base' => 'base de penalización',
        'penalty_cap_percent' => '% máximo de penalización',
        'paymentAmount' => 'monto',
        ...
        'collateralDescription' => 'descripción',
        ...
        'guarantorRelationship' => 'parentesco',
        'rejectReason' => 'motivo',
    ],
