...
<body class="flex min-h-screen items-center justify-center bg-gray-100 font-sans antialiased">
    <div class="text-center">
        <p class="text-6xl font-black text-gray-300">403</p>
        <p class="mt-3 text-lg font-medium text-gray-700">{{ $exception->getMessage() && $exception->getMessage() !== 'This action is unauthorized.' ? $exception->getMessage() : __('You do not have permission to view this page.') }}</p>
